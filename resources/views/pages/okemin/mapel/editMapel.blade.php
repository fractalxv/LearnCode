            ...
            <div class="card card-primary">
                ...
                <form role="form" action="/Okemin/Mapel/Update/{{ $mapel->id }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label for="input1" class="col-sm-2 col-form-label">Nama Materi</label>
                        <div class="col-sm-10">
                          <input value="{{ $mapel->nama_mapel }}" name="nama_mapel" type="name" class="form-control" id="input1" placeholder="Nama Materi">
