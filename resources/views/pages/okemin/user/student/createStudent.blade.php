        ...
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <form role="form" action="/Okemin/User/Student/Create/Send" method="post" enctype="multipart/form-data">
                    ...
                    <h5>DATA AKADEMIK</h5>
                    <div class="form-group row">
                        <label for="input8" class="col-sm-2 col-form-label">StudentID*</label>
                        <div class="col-sm-10">
                          <input name="nisn" type="text" class="form-control" id="input8" placeholder="StudentID">
                            @if($errors->has('nisn'))
                                <div class="text-danger">
                                    {{ $errors->first('nisn')}}
                                </div>
                    ...
                    <div class="form-group row">
                        <label for="input8" class="col-sm-2 col-form-label">Tahun mulai*</label>
                        <div class="col-sm-10">
                          <input name="tahun_masuk" type="text" class="form-control" id="input8" placeholder="Tahun mulai">
                    ...
                    <div class="form-group row">
                        <label for="input9" class="col-sm-2 col-form-label">Status*</label>
                        <div class="col-sm-10">
                          <input name="jabatan" type="text" class="form-control" id="input9" placeholder="Status">
                        </div>
                    </div>
