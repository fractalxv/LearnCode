                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="settings">
                                ...
                                <form class="form-horizontal" method="post" action="/Okemin/User/Teacher/Profile/Send/{{ $teacher->id }}">
                                    ...
                                    <h5>INFO AKADEMIK</h5>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">MentorID*</label>
                                        <div class="col-sm-10">
                                            <input  name="nip" type="text" class="form-control" placeholder="MentorID" value="{{ $teacher->nip }}">
                                            @if($errors->has('nip'))
                                                <div class="text-danger">
                                                    {{ $errors->first('nip')}}
                                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="jabatan" type="text" class="form-control" placeholder="Role Mentor" value="{{ $teacher->jabatan }}">
                                        </div>
                                    </div>
